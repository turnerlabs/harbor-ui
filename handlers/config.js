var pkgConfig = require('../package.json'),
    ...
    CONFIG_DATA = {
        ...
        send_telemetry: process.env.HARBOR_TELEMETRY_KEY ? true : false,
        healthcheck: process.env.HEALTHCHECK || '/_hc',
        port: process.env.PORT || '7890',
        authCacheTtl: process.env.AUTH_CACHE_TTL || 1000 * 60 * 30,
        ...
        lb_types_allowed: process.env.LB_TYPES_ALLOWED || 'default (alb):default,alb:alb,elb:elb',
